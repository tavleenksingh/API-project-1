...
var colors = ["#667DFF", "#70C2FF", "#8EFFFA", "#81E8C6",
             "#9BFFC2", "#81E88C", "#AFE881", "#37DC72",
             "#7BD274", "#7ADC90", "#77C59E", "#7ADCC7","#74CBD2", "#7279D2"];

var restaurants = ["Korean", "Indian", "Italian","Burgers", "Breakfast",
                   "Mexican", "Vietnamese", "Chinese",
...
function drawRouletteWheel() {
  ...
  if (canvas.getContext) {
    ...
    ctx.font = '18px "Palatino Linotype", "Book Antiqua", Palatino, serif';
